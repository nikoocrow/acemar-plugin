...
require_once ACEMAR_BLOCKS_PATH . 'includes/cpt-panel.php';
...
class Acemar_Blocks {
    ...
    public function register_blocks() {
        ...
        register_block_type(ACEMAR_BLOCKS_PATH . 'build/paneles-grid');
    }
    ...
    public function inject_caracteristicas_css() {
        ...
        echo '<style id="acemar-caracteristicas-inline">
            ...
            @media (max-width: 900px) {
                ...
                .acemar-ci__col-imagen { order: 1 !important; padding: 40px !important; }
